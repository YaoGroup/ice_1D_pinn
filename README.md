# Quick Installation
Before you begin, ensure that you have Python installed on your system. ```[pinn_clusters]```(https://github.com/YaoGroup/pinn_clusters) is compatible with Python 3.x. To install ```pinn_clusters```, simply run the following command in your terminal:
```
